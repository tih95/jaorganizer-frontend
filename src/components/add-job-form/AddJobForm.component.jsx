...
const AddJobForm = ({ history, user }) => {
	...
	const formik = useFormik({
		...
		validationSchema: Yup.object({
			...
			dateApplied: Yup.date().required('Required'),
		...
		<form onSubmit={formik.handleSubmit}>
			<Stack>
				<FormControl marginBottom="1.5em">
					...
					<InputGroup>
						<Input
							...
							borderColor={formik.touched.title && formik.errors.title ? '#FC8181' : '#CBD5E0'}
						/>
					</InputGroup>
				...
				<FormControl marginBottom="1.5em">
					...
					<InputGroup>
						<Input
							...
							borderColor={formik.touched.date && formik.errors.dateApplied ? '#FC8181' : '#CBD5E0'}
						/>
					</InputGroup>
				...
				<FormControl marginBottom="1.5em">
					...
					<InputGroup>
						<Input
							...
							borderColor={formik.touched.jobLink && formik.errors.jobLink ? '#FC8181' : '#CBD5E0'}
						/>
					</InputGroup>
				...
				<FormControl marginBottom="1.5em">
					...
					<Select placeholder="Select status" onChange={formik.handleChange} name="status">
						{options.map((option) => (
				...
				<FormControl marginBottom="1.5em">
					...
					<InputGroup>
						<Input
							...
							borderColor={formik.touched.location && formik.errors.location ? '#FC8181' : '#CBD5E0'}
						/>
					</InputGroup>
				...
				<FormControl marginBottom="1.5em">
					...
					<InputGroup>
						<Input
							...
							borderColor={formik.touched.company && formik.errors.company ? '#FC8181' : '#CBD5E0'}
						/>
					</InputGroup>
